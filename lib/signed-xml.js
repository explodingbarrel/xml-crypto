...
SignedXml.CanonicalizationAlgorithms = {
	...
	'http://www.w3.org/TR/2001/REC-xml-c14n-20010315': ExclusiveCanonicalization,		// moko: added win-phone receipt canonical url
...
SignedXml.prototype.loadSignature = function(signatureXml) {
	...
	var canonialAlg = utils.findFirst(doc, "//*[local-name(.)='CanonicalizationMethod']/@Algorithm").value;

	for (var i in references) {
		this.loadReference(references[i], canonialAlg)
	}
 ...
 *
 */
SignedXml.prototype.loadReference = function(ref, canonialAlg) {
